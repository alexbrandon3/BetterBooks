...
router.get("/dashboard-metrics", authenticate, reportRateLimiter, (req, res) => getDashboardMetrics(req as AuthenticatedRequest, res));

router.get("/suggestion-summary", authenticate, reportRateLimiter, (req, res) => getSuggestionSummary(req as AuthenticatedRequest, res));
